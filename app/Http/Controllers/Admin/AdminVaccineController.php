...
class AdminVaccineController extends Controller
{
    ...
    /**
     * Update vaccine report status
     */
    public function updateStatus(Request $request, $id)
    {
        $report = VaccineAccountabilityReport::findOrFail($id);
        ...
        if ($validated['status'] === 'approved') {
            ...
            $updateData['rejected_reason'] = $validated['rejected_reason'] ?? null;
        } elseif ($validated['status'] === 'pending_revision') {
            $updateData['revision_notes'] = $validated['revision_notes'] ?? null;
        }
