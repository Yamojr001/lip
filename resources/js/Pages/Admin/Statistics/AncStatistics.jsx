...
import { Stethoscope, Users, Activity, TrendingUp, ArrowLeft, Download, Calendar, Filter as FilterIcon } from 'lucide-react';
...
export default function AncStatistics() {
    const { statistics = {}, chartData = {}, dropdowns = {}, filters: initialFilters = {} } = usePage().props;

    const handleFilterChange = (newFilters) => {
        router.get(route('admin.statistics.anc'), newFilters, { preserveState: true, replace: true });
    };
