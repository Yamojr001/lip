...
import { Syringe, Baby, Activity, TrendingUp, ArrowLeft, Download, Shield, CheckCircle, Filter as FilterIcon } from 'lucide-react';
...
export default function ImmunizationStatistics() {
    const { immunizationData = {}, chartData = {}, statistics = {}, dropdowns = {}, filters: initialFilters = {} } = usePage().props;

    const handleFilterChange = (newFilters) => {
        router.get(route('admin.statistics.immunization'), newFilters, { preserveState: true, replace: true });
    };
