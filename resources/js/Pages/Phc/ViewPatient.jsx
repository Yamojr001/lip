...
import { ArrowLeft, Edit, Calendar, User, MapPin, Stethoscope, Baby, CreditCard } from "lucide-react";
            ...
            <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl p-6 mb-6 shadow-lg">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <div className="mt-4 md:mt-0 text-right">
                        ...
                        <p className="text-purple-100">Registered: {formatDate(patient.date_of_registration)}</p>
                    </div>
                </div>
            </div>
