...
import { CheckCircle, ArrowLeft, Save, Building, AlertCircle } from "lucide-react";

// Custom Debounced Input Components (same as EditPatient.jsx)
      ...
      <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl mx-auto">
        ...
        <InputSection title="1. Personal & Location Information">
            ...
            <select 
              ...
              className={selectClass}
            >
                <option value="">Health Facility (Current Site) *</option>
        ...
        {/* --- Rest of the form sections remain the same as EditPatient.jsx --- */}
        ...
        {/* ... Include all other sections from EditPatient.jsx ... */}
